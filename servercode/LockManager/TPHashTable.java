...
//        }
        ...
        Vector elemVect = new Vector(size); // return object
...
//        }
    ...
    public Vector allElements() 
    {
        ...
        {    
            ...
            if ( vect.size() > 0 ) // contains elements? 
            {   
...
//        }
    ...
    private synchronized int getHashSlot(XObj xobj)
    {
    	int hashSlot = (xobj.hashCode() % this.iSize);
        if ( hashSlot < 0 ) 
        {
