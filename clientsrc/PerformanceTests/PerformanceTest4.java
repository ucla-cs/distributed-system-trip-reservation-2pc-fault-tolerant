...
//			flightSeats = 40;
//			flightPrice = 1;
//			if(mw.addRooms(Id,"abc",flightSeats,flightPrice))
...
//			flightSeats = 40;
//			flightPrice = 1;
//			if(mw.addCars(Id,"abc",flightSeats,flightPrice))
//				System.out.println("Rooms added");
//			else
//				System.out.println("Flight could not be added");
//		}
...
//		
//		 ThreadClient2 t1, t2;
//			t1 = new ThreadClient2 ( 1,mw1);
//			t2 = new ThreadClient2 ( 2,mw2);
//			t1.start ();
//			t2.start ();
//			
...
//    int threadId;
//
//    public ThreadClient2 (int threadId,MiddleWare middleware) {
...
//			flightSeats = 40;
//			flightPrice = 1;
//			if(mw.newCustomer(Id,2))
//				System.out.println("Customer 2 added");
//			else
//				System.out.println("Customer  could not be added");
//		}
//		catch(Exception e){
